...
namespace Roller.Repository.AccountRepo
{
   public interface IAccountManager : IDependencyRegister
    {
        //Task<IEnumerable<User>> GetAllUsersWithClaims();
       // Task<UserModel> GetAllUsersWithClaims()
        Task<UserViewModel> GetAllUsersWithClaims();
        Task<UserViewModel> GetUsersClaims(User request);
