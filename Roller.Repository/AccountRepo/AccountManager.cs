...
using static Roller.Repository.AccountRepo.UserModel;
   ...
   public class AccountManager: IAccountManager
    {
        ...
        public async Task<UserViewModel> GetAllUsersWithClaims()
        {
        ...
        //public async Task<UserViewModel> GetIndividualClaims(User use)
        //{
        //    var users = await _userManager.Users.SingleOrDefaultAsync(x=>x.Id == use.Id);
        //    var model = new UserViewModel
        //    {
        //        Users = users.Select(u => new UserModel
        //        {
        ...
        public async Task<UserViewModel> GetUsersClaims(User request)
        {
            var users = await _userManager.Users.ToListAsync();
            var model = new UserViewModel
            {
