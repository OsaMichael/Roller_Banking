...
////        private readonly ITransManager _transMgr;
////        public AccountsController (RollerDataContext context, ITransManager transMgr)
////        {
////            _context = context;
////            _transMgr = transMgr;
////        }
...
////        {
////            var account =  _transMgr.GetTranApi(id);
////          // var result =  _context.Accounts.Where(u=>u.AccountId == id);
////            return Ok(account);
...
////        public IActionResult GetMer(int id, int offset, int limit)
////        {
////            var result = _transMgr.GetTranApiIds(id, offset, limit);
////            return Ok(result);
